...
| 113 | 2026-08-21 | An `effort/*` tag names the project, not the individual effort. Counted: 114, 103 and 74 notes on the three commonest, against one each on the two I first cited as the convention. My diagnosis was wrong; the Courier filed a project under its parent organisation | assumed |
